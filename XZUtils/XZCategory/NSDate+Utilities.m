...
+ (NSString *)getWeekTime
{
    ...
    NSDateComponents *comp = [calendar components:NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitWeekday | NSCalendarUnitWeekdayOrdinal  fromDate:nowDate];
    // 获取今天是周几
    ...
    NSString *firstDay = [NSString stringWithFormat:@"%@ %@",[formatter stringFromDate:firstDayOfWeek],@"周一"];
    NSString *lastDay = [NSString stringWithFormat:@"%@ %@",[formatter stringFromDate:lastDayOfWeek],@"周日"];

    NSString *dateStr = [NSString stringWithFormat:@"%@ 至 %@",firstDay,lastDay];
    
    return dateStr;
    
}

- (NSString *)stringWeekWithFormat:(NSString *)format{
    NSDate *nowDate = [NSDate date];
    NSCalendar *calendar = [NSCalendar currentCalendar];
    NSDateComponents *comp = [calendar components:NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitWeekday | NSCalendarUnitWeekdayOrdinal  fromDate:nowDate];
    // 获取今天是周几
    ...
    dateStr = [NSString stringWithFormat:@"%@ %@",dateStr,weekArr[weekDay - 1]];//
    return dateStr;
}
@end
